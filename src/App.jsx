...
const globalStyles = `
  ...
  /* --- Stili per le note a piè di pagina (solo PDF) --- */
  .footnote-section {
    display: none;
  }
                ...
                {packages.map((pkg) => (
                  <tr key={pkg.id}>
                    ...
                    <td className="note-cell">
                      {/* Web View: Icona interattiva o trattino */}
                      ...
                      {/* PDF View: "vedi sotto" o trattino */}
                      <span className="only-print">
                        {pkg.notes ? 'vedi sotto' : '—'}
                      </span>
                    </td>
